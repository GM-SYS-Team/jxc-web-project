 ...
 */
public class GmsRuntimeException extends RuntimeException {
	 ...
	 * @param cause  异常堆栈
	 */
	public GmsRuntimeException(Result result, Throwable cause) {
	 ...
	 * @param msg  错误消息
	 */
	public GmsRuntimeException(int code, String msg) {
		super(msg);
	 ...
	 */
	public GmsRuntimeException(Result result, String detail) {
	 ...
	 * @param cause  异常堆栈
	 */
	public GmsRuntimeException(Result result, String detail, Throwable cause) {
	 ...
	 * @param cause 异常堆栈
	 */
	public GmsRuntimeException(int code, String msg, Throwable cause) {
		super(msg, cause);
		this.result = new Result(code, msg);
	}
	 ...
	 * @param cause	异常堆栈
	 */
	public GmsRuntimeException(int code, Throwable cause) {
		super(cause);
