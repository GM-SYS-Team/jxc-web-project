...
public interface PushJobService {
    ...
    void delete(Long pushJobId, String currentUser);
     ...
     * @return 已推送的PushJob
     */
    PushJob submitPushJob(Long pushJobId, String currentUser) throws Exception;
     ...
     * @return 已撤回的PushJob
     */
    PushJob withdrawPushJob(Long pushJobId, String currentUser) throws Exception;
