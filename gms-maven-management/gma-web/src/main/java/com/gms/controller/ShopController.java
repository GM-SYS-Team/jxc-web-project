...
public class ShopController extends BaseController{
	 ...
	 */
	@RequestMapping("/save")
	public Map<String,Object> save(Shop shop,HttpServletRequest request)throws Exception{
	...
	public Map<String,Object> delete(String ids)throws Exception{
		...
		for(int i=0;i<idsStr.length;i++){
			...
			logService.save(new Log(Log.DELETE_ACTION,"删除商铺信息"+shopService.findById(id)));  // 写入日志
